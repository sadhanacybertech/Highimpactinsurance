          ...
          <div className="row">
            <div className="col-lg-10 mx-auto text-center">
              ...
              <div className="life-hero-actions">
                <Link to="/contact" className="life-hero-btn primary">
                  Get a Free Quote
                </Link>


                <a href="tel:+918334900998" className="life-hero-btn secondary">
                  Talk to an Expert
          ...
          <div className="row align-items-center gy-4">
            ...
            <div className="col-lg-4 text-lg-end text-center">
              <div className="life-cta-light-actions">
                <Link to="/contact" className="life-cta-light-btn primary">
                  Get Free Quote <FaArrowRight />
                </Link>

                <a href="tel:+918334900998" className="life-cta-light-btn secondary">
